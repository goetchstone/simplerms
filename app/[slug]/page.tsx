...
const RESERVED = new Set(["about", "book", "contact", "privacy", "terms", "support", "blog", "portal", "dashboard", "api", "pricing", "services", "nonprofits", "careers", "apple-business", "ai-risk", "ownership", "resources"]);
