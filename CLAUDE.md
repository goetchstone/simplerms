...
- **Founder:** Goetch Stone — 20+ years IT, Director of IT at multi-location retailer, PSU MacAdmins presenter — 2025 workshop (Apple Device Administration Essentials, hands-on) + 2026 conference sessions (AI session + Imposter Syndrome session). Use "presenter" not "instructor" or "speaker" — that's the term he prefers.
